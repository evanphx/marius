...
namespace immix {
  ...
  public:
     ...
     */
    virtual void blocks_left(int count) = 0;
  };
    ...
    Block& get_block() {
      ...
      for(;;) {
        ...
        if(chunk_cursor_ == chunks_.size() - 1) {
          triggers_.blocks_left(cBlocksPerChunk - block_cursor_);
        }
  ...
  public:
    virtual ~Allocator() {}
    virtual Address allocate(unsigned bytes) = 0;
  };
  ...
  template <typename Describer, typename Object> class GC;
   ...
   */
  template <typename Describer, typename Object>
  class Marker {
    GC<Describer, Object>* gc;
    Allocator& alloc;

  public:
    Marker(GC<Describer, Object>* gc, Allocator& alloc)
      : gc(gc)
      , alloc(alloc)
    {}
  ...
  public:
    typedef std::vector<Object> MarkStack;
  ...
  public:
    ...
    /**
     * Called to mark the object at Object +obj+ as live.
     *
    ...
    /**
     * Calls the Describer to scan from each of the Objects in the mark stack.
     */
    bool process_mark_stack(Allocator& alloc) {
      Marker<Describer, Object> mark(this, alloc);
